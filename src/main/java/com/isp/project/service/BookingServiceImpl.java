...
public class BookingServiceImpl implements BookingService{
    ...
    public List<BookingRoomDTO> getAllBooking() {
        List<Object[]> rawResults = bookingRepository.findAllBookingRoom(); // Ensure you are using the correct method name
        List<BookingRoomDTO> bookingRoomDTOs = new ArrayList<>();
    
        for (Object[] rawResult : rawResults) {
            // Extracting data from the rawResult array and casting it to the appropriate types
            ...
            BookingRoomDTO dto = new BookingRoomDTO(bookingId, customerName, checkInDate, checkOutDate, bookingDate, customerQuantity, roomId, employeeName);
...
public List<BookingRoomDTO> getAllBookingByName(String name) {
    List<Object[]> rawResults = bookingRepository.findBookingRoomByCustomerName(name); // Ensure you are using the correct method name
    List<BookingRoomDTO> bookingRoomDTOs = new ArrayList<>();
